...
export const CONTENT_PROVIDER_HINT = `Provider to read from. "auto" (or omit) uses "all", which tries Wayback first and falls back to Common Crawl. Archive.today, WebCite and Perma.cc serve no readable capture bodies and answer as unsupported. Archive-It requires a numeric collection id.`;
