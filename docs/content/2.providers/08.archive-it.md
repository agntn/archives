...
Collection-scoped indexes answer in index order and ignore bounds they do not support, so the provider pulls a bounded page of captures and picks the closest one locally rather than trusting the server to.
